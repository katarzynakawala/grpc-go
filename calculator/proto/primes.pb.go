...
type CalcPrimesRequest struct {
	...
	Digit int32 `protobuf:"varint,1,opt,name=digit,proto3" json:"digit,omitempty"`
}

func (x *CalcPrimesRequest) Reset() {
	*x = CalcPrimesRequest{}
...
func (x *CalcPrimesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CalcPrimesRequest) ProtoMessage() {}

func (x *CalcPrimesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_primes_proto_msgTypes[0]
...
// Deprecated: Use CalcPrimesRequest.ProtoReflect.Descriptor instead.
func (*CalcPrimesRequest) Descriptor() ([]byte, []int) {
	return file_primes_proto_rawDescGZIP(), []int{0}
}

func (x *CalcPrimesRequest) GetDigit() int32 {
	if x != nil {
		return x.Digit
	}
	return 0
...
var file_primes_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x29, 0x0a, 0x11, 0x43, 0x61,
	0x6c, 0x63, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x14, 0x0a, 0x05, 0x64, 0x69, 0x67, 0x69, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05,
	0x64, 0x69, 0x67, 0x69, 0x74, 0x22, 0x28, 0x0a, 0x0e, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x73, 0x52,
	...
	0x74, 0x61, 0x72, 0x7a, 0x79, 0x6e, 0x61, 0x6b, 0x61, 0x77, 0x61, 0x6c, 0x61, 0x2f, 0x67, 0x72,
...
var file_primes_proto_goTypes = []interface{}{
	(*CalcPrimesRequest)(nil), // 0: calculator.CalcPrimesRequest
...
func file_primes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_primes_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CalcPrimesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
